    ...
    Private Sub CmdSimpan_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdSimpan.Click
        ...
        Else
            ...
            If Not rd.HasRows Then
                Dim sqltambah As String = "Insert into barang(Kode_Barang,Nama_Barang,Dosis,Bentuk,Harga, jumlah_barang,satuan) values " & _
                "('" & TKode.Text & "','" & TNama.Text & "','" & TBeli.Text & "','" & TJumlah.Text & "','" & THarga.Text & "','" & TJual.Text & "','" & CmbSatuan.Text & "')"
